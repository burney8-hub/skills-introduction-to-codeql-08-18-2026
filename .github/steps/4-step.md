...
1. Click on **Closed** to show our recently resolved alert.
   ...
   <img width="350" alt="image" src="https://github.com/burney8-hub/skills-introduction-to-codeql-08-18-2026/blob/main/.github/images/closed-alerts-button.png?raw=true" />

1. Open our alert and notice the audit trail now includes how the alert was fixed.

   <img width="350" alt="image" src="https://github.com/burney8-hub/skills-introduction-to-codeql-08-18-2026/blob/main/.github/images/audit-trail-fixed-alert.png?raw=true" />
